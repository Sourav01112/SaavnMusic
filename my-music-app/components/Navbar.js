        ...
        <div className=" absolute navbar bg-base-100">
          ...
          <div onClick={() => setPage("")} className="navbar-center">
            <a className="btn btn-ghost normal-case text-xl">
              {" "}
              <CgMusic className=" mr-2" /> SaavnMusic
            </a>
          </div>
          ...
          <div>
            ...
            {/* <p className="  text-sm text-center font-semibold mb-5 bg-base-100 py-3 rounded-lg active:scale-95 cursor-pointer">
              ...
              <a
                ...
                href="https://sourav01112.github.io/"
              >
                Visit my Portfolio
              </a>
            </p> */}
            ...
            <li>
              <a
                ...
                className={` ${
                  page === "search" && "bg-blue-500 text-white"
                }    font-semibold`}
              >
                {" "}
                <RiSearchEyeFill className=" text-xl" /> Search{" "}
              </a>
            </li>
            <li>
              <a
                ...
                className={` ${
                  page === "playingnow" && "bg-blue-500 text-white"
                }    font-semibold`}
              >
                {" "}
            ...
            <li>
              <a
                ...
                className={` ${
                  page === "musiclib" && "bg-blue-500 text-white"
                }    font-semibold`}
              >
                {" "}
          ...
          <div className=" ">
            <li>
              <div
                ...
                className={` ${
                  page === "settings" && "bg-blue-500 text-white"
                }    font-semibold`}
              >
                {" "}
