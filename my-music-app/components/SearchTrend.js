  ...
  return (
    <div>
      ...
      <div className=" flex flex-wrap mt-10 gap-5">
        <div
          data-aos="zoom-in"
          className=" relative shadow-md hover:brightness-110 transition-all bg-[#8d67ab] w-80 h-40 rounded-lg"
        >
        ...
        <div
          data-aos="zoom-in"
          className=" relative shadow-md hover:brightness-110 transition-all bg-[#f037a5] w-80 h-40 rounded-lg"
        >
          <h1 className=" absolute top-5 left-5 text-white font-bold text-2xl ">
            Pop Mix
          </h1>
        ...
        <div
          data-aos="zoom-in"
          className=" relative shadow-md hover:brightness-110 transition-all bg-[#148a08] w-80 h-40 rounded-lg"
        >
          <h1 className=" absolute top-5 left-5 text-white font-bold text-2xl ">
            Rockeras
          </h1>
        ...
        <div
          data-aos="zoom-in"
          className=" relative shadow-md hover:brightness-110 transition-all bg-[#19e68c] w-80 h-40 rounded-lg"
        >
          <h1 className=" absolute top-5 left-5 text-white font-bold text-2xl ">
            K-Pop
          </h1>
